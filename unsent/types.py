...
class Route(BaseModel):
    id: str = Field(..., description='The ID of the route')
    domainId: str = Field(..., description='The ID of the domain')
    providerConnectionId: str = Field(
        ..., description='The ID of the provider connection'
    )
    weight: int = Field(..., description='Relative routing weight', examples=[100])
    isActive: bool = Field(..., description='Whether the route is active')
    status: str = Field(..., description='The status of the domain')
    provider: Provider = Field(
        ..., description='The email provider for this route', examples=['ses']
    )
    region: str | None = Field(
        'us-east-1', description='The region of the provider', examples=['us-east-1']
    )
    clickTracking: bool | None = Field(
        False, description='Whether click tracking is enabled'
    )
    openTracking: bool | None = Field(
        False, description='Whether open tracking is enabled'
    )
    publicKey: str | None = Field(None, description='The DKIM public key')
    dkimStatus: str | None = Field(None, description='The DKIM verification status')
    spfDetails: str | None = Field(None, description='The SPF verification details')
    dmarcAdded: bool | None = Field(False, description='Whether DMARC is added')
    isVerifying: bool | None = Field(
        False, description='Whether the route is being verified'
    )
    errorMessage: str | None = Field(None, description='The verification error message')
    subdomain: str | None = Field(None, description='The subdomain')
    dnsRecords: list[DnsRecord] = Field(
        ..., description='The DNS records for this route'
    )
    createdAt: str = Field(..., description='The creation date')
    updatedAt: str = Field(..., description='The last update date')
...
class DomainsGetResponseItem(BaseModel):
    ...
    teamId: str = Field(..., description='The ID of the team')
    autoRouting: bool | None = Field(
        False, description='Whether auto-routing is enabled'
    )
    routes: list[Route] = Field(..., description='The provider routes for this domain')
...
class DomainsPostResponse(BaseModel):
    ...
    routes: list[Route1] = Field(..., description='The provider routes for this domain')
    createdAt: str = Field(..., description='The creation date of the domain')
    updatedAt: str = Field(..., description='The last update date of the domain')
...
class DomainsIdGetResponse(BaseModel):
    ...
    routes: list[Route2] = Field(..., description='The provider routes for this domain')
    createdAt: str = Field(..., description='The creation date of the domain')
    updatedAt: str = Field(..., description='The last update date of the domain')
...
class DomainsIdRoutesGetResponseItem(BaseModel):
    id: str = Field(..., description='The ID of the route')
    domainId: str = Field(..., description='The ID of the domain')
    providerConnectionId: str = Field(
        ..., description='The ID of the provider connection'
    ...
    errorMessage: str | None = Field(None, description='The verification error message')
    subdomain: str | None = Field(None, description='The subdomain')
    dnsRecords: list[DnsRecord3] = Field(
        ..., description='The DNS records for this route'
    )
    createdAt: str = Field(..., description='The creation date')
    updatedAt: str = Field(..., description='The last update date')
...
class DomainsIdRoutesGetResponse(RootModel[list[DomainsIdRoutesGetResponseItem]]):
    root: list[DomainsIdRoutesGetResponseItem]


class DomainsIdRoutesPostRequest(BaseModel):
    providerConnectionId: UUID
    weight: conint(ge=1) | None = 100


class DnsRecord4(BaseModel):
    type: Type = Field(..., description='DNS record type', examples=['TXT'])
    name: str = Field(..., description='DNS record name', examples=['mail'])
    value: str = Field(
        ...,
...
class DomainsIdRoutesPostResponse(BaseModel):
    id: str = Field(..., description='The ID of the route')
    domainId: str = Field(..., description='The ID of the domain')
    providerConnectionId: str = Field(
        ..., description='The ID of the provider connection'
    ...
    errorMessage: str | None = Field(None, description='The verification error message')
    subdomain: str | None = Field(None, description='The subdomain')
    dnsRecords: list[DnsRecord4] = Field(
        ..., description='The DNS records for this route'
    )
    createdAt: str = Field(..., description='The creation date')
    updatedAt: str = Field(..., description='The last update date')
...
class DomainsIdRoutesRouteIdPatchRequest(BaseModel):
    weight: conint(ge=1) | None = None
    clickTracking: bool | None = None
...
class ProviderConnectionsGetResponse(RootModel[list[dict[str, Any]]]):
    root: list[dict[str, Any]]
...
class ProviderConnectionsPostRequest(BaseModel):
    provider: Provider5
    name: constr(min_length=1)
    credentials: Credentials


class ProviderConnectionsPostResponse(BaseModel):
    pass


class ProviderConnectionsIdDeleteResponse(BaseModel):
    pass
